...
export default function Hero() {
  return (
    <div>
      <div className="bg-slate-50 flex h-full pt-28  max-lg:mt-40 justify-around max-lg:flex-col-reverse py-10 items-center">
        <div className=" max-md:flex max-w-[500px] max-md:flex-wrap px-8 max-md:justify-center  ">
          ...
          <h2 className="text-elipsis">
            Tukulan merupakan platform jual beli tumbuhan yang indah serta
            memiliki ciri khuusu yang tidak ada di tempat lainnya,
